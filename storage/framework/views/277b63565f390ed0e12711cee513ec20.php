...
<?php endif; ?>
    ...
    <div class="relative min-h-screen w-full overflow-x-hidden font-[Inter]">
        ...
        <div class="fixed inset-0 -z-10">
            ...
            <img
            src="<?php echo e(asset('images/company.jpeg')); ?>"
            alt="Company"
        ...
        <div class="min-h-screen flex items-center justify-center px-4 py-10">
            <div class="w-full max-w-5xl">
                <div class="grid grid-cols-1 md:grid-cols-2 overflow-hidden rounded-3xl shadow-2xl ring-1 ring-white/10 bg-white/5 backdrop-blur">
                    ...
                    <div class="bg-white p-8 sm:p-10 md:p-12">
                        <div class="max-w-md">
                            ...
                            <form method="POST" action="<?php echo e(route('login')); ?>" class="mt-8 space-y-4">
                                <?php echo csrf_field(); ?>
                ...
                <div class="mt-6 text-center text-xs text-white/50">
                    © <?php echo e(date('Y')); ?> PT. Rajapaksi
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Coding Workplace\Magang PT. Weba Corporation\weba database pc\resources\views/auth/login.blade.php ENDPATH**/ ?>